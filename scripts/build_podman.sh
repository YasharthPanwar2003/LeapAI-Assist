...
echo "  Size:  $(${ENGINE} image inspect "${IMAGE_NAME}:${IMAGE_TAG}" --format '{{.Size}}' 2>/dev/null || echo 'unknown')"
echo ""
...
echo ""
echo "  Or directly:"
echo "    ${ENGINE} run -it --rm -p 8080:8080 -v /var/lib/suse-ai/models:/models:ro ${IMAGE_NAME}:${IMAGE_TAG}"
